...
export default class AthleteAlert extends Component {
    ...
    render() {
        ...
        * athlete's preWeightData at index zero and the data is formatted in decimal form and given four precision points.*/
        ...
        /* If the athlete's postWeightData at index zero is not undefined, then the postWeightData set to the date of the
         * athlete's postWeightData at index zero and the data will be formatted into decimal form and given four precision points.*/
         ...
         * then the currentWeight set to the weight of the athlete's postWeightData at index zero.
         * The athlete's current weight will then be formatted into decimal form and given four precision points.*/
        ...
        /* If the postWeightDate is not equal to null, then the currentWeight would be set to postWeightData at index zero.
         * The athlete's current weight will then be formatted into decimal form and given four precision points.*/
        else if(postWeightDate !== null) {
            currentWeight =  athlete.postWeightData[0].weight;
            currentWeight = Number.parseFloat(currentWeight).toPrecision(4);
        }
        /* If the preWeightDate is not equal to null, then the currentWeight set to preWeightData at index zero.
         * The athlete's current weight will then be formatted into decimal form and given four precision points.*/
