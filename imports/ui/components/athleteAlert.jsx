...
export default class AthleteAlert extends Component {
    ...
    render() {
        ...
        /* If the athlete's preWeightData at index zero is not undefined, then the preWeightData would be set to the
        *  date of the athlete's preWeightData at index zero and the preWeightData will be formatted into decimal
        *  format and given four precision points.*/
        ...
        /* If the athlete's postWeightData at index zero is not undefined, then the postWeightData would be set to
        *  the date of the athlete's postWeightData at index zero and the postWeightData will be formatted
        *  into decimal format and given four precision points.*/
        ...
        /* If the athlete's postWeightDate at index zero is not equal to null -- AND -- If the athlete's preWeightDate
         * at index zero is not equal to null then the currentWeight would be set to the weight of the athlete's
         * postWeightData at index zero. The athlete's current weight will then be formatted into decimal format
         * and given four precision points.*/
        ...
        /* If the postWeightDate is not equal to null, then the currentWeight would be set to the weight of the
         * postWeightData at index zero. The athlete's current weight will then be formatted into decimal format
         * and given four precision points.*/
        ...
        /* If the preWeightDate is not equal to null, then the currentWeight would be set to the weight of the preWeightData
         * at index zero. The athlete's current weight will then be formatted into decimal format and given four precision points.*/
